...
const StrategicPartnershipsModule = () => {
  ...
  const module = strategicPartnershipsCourseData[moduleIndex];
      ...
      try {
        ...
        if (!docSnap.exists()) {
          await setDoc(userRef, {
            'strategic-partnerships': [module.id]
          });
        } else {
          await updateDoc(userRef, {
            'strategic-partnerships': arrayUnion(module.id)
          });
        }
  ...
  return (
    <div className="min-h-screen bg-background pb-20">
      <div className="container mx-auto px-4 py-8">
        <Button 
          variant="ghost" 
          onClick={() => navigate('/course/strategic-partnerships')}
          className="mb-6"
        >
              ...
              <CardContent>
                {!quizStarted ? (
                  ...
                  <div className="text-center py-8">
                    ...
                    <Button onClick={() => navigate('/course/strategic-partnerships')}>
                      Return to Course
                    </Button>
                  </div>
                )}
...
export default StrategicPartnershipsModule;
