...
import { appDevelopmentHealthcareCourseModules } from '../../data/appDevelopmentHealthcareCourseData';
import { auth, db } from '../../lib/firebase';
import { doc, getDoc } from 'firebase/firestore';

const AppDevelopmentHealthcareCourse = () => {
    ...
    const fetchProgress = async () => {
      ...
      if (user) {
        try {
          ...
          if (docSnap.exists() && docSnap.data()['app-development-healthcare']) {
            setUserProgress(docSnap.data()['app-development-healthcare'].modules || {});
          }
        } catch (error) {
  ...
  const progressPercentage = Math.round((completedModules / appDevelopmentHealthcareCourseModules.length) * 100);
    ...
    <div className="min-h-screen bg-gray-50 pb-12">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
            <div>
              ...
              <h1 className="text-4xl font-bold mb-4">App Development in Healthcare</h1>
              <p className="text-xl text-indigo-100 max-w-2xl">
                Master web and mobile app development for healthcare. Explore traditional coding vs. AI-assisted 'vibecoding', modern stacks, and compliance.
              </p>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 min-w-[300px]">
              ...
              <div className="flex justify-between text-sm text-indigo-200">
                <span>{completedModules}/{appDevelopmentHealthcareCourseModules.length} Modules</span>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-8">
        <div className="grid gap-6">
          {appDevelopmentHealthcareCourseModules.map((module, index) => {
            const status = getModuleStatus(module.id);
            const isLocked = index > 0 && getModuleStatus(appDevelopmentHealthcareCourseModules[index - 1].id) !== 'completed';
              ...
              >
                <div className="p-6 flex flex-col md:flex-row md:items-center gap-6">
                  ...
                  <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 min-w-[200px]">
                    ...
                    <button
                      onClick={() => !isLocked && navigate(`/course/app-development-healthcare/module/${module.id}`)}
                      disabled={isLocked}
...
export default AppDevelopmentHealthcareCourse;
