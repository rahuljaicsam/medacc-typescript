...
import { biomaterialsCourseModules } from '../../data/biomaterialsCourseData';
import { auth, db } from '../../lib/firebase';
import { doc, getDoc } from 'firebase/firestore';

const BiomaterialsCourse = () => {
    ...
    const fetchProgress = async () => {
      ...
      if (user) {
        try {
          ...
          if (docSnap.exists() && docSnap.data()['biomaterials-innovation']) {
            setUserProgress(docSnap.data()['biomaterials-innovation'].modules || {});
          }
        } catch (error) {
  ...
  const progressPercentage = Math.round((completedModules / biomaterialsCourseModules.length) * 100);

  return (
    <div className="min-h-screen bg-gray-50 pb-12">
      {/* Header */}
      <div className="bg-purple-900 text-white pt-24 pb-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
            <div>
              ...
              <h1 className="text-4xl font-bold mb-4">Biomaterials Innovation</h1>
              <p className="text-xl text-purple-100 max-w-2xl">
                Master the fundamentals of biomaterial design, from metals and polymers to smart materials and tissue engineering.
              </p>
            </div>
            
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 min-w-[300px]">
              <div className="flex justify-between items-center mb-2">
                <span className="text-purple-100">Course Progress</span>
              ...
              <div className="flex justify-between text-sm text-purple-200">
                <span>{completedModules}/{biomaterialsCourseModules.length} Modules</span>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-8">
        <div className="grid gap-6">
          {biomaterialsCourseModules.map((module, index) => {
            const status = getModuleStatus(module.id);
            const isLocked = index > 0 && getModuleStatus(biomaterialsCourseModules[index - 1].id) !== 'completed';
              ...
              >
                <div className="p-6 flex flex-col md:flex-row md:items-center gap-6">
                  <div className={`flex-shrink-0 w-16 h-16 rounded-full flex items-center justify-center ${
                    status === 'completed' ? 'bg-purple-100 text-purple-600' :
                  ...
                  <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 min-w-[200px]">
                    ...
                    <button
                      onClick={() => !isLocked && navigate(`/course/biomaterials/module/${module.id}`)}
                      disabled={isLocked}
...
export default BiomaterialsCourse;
