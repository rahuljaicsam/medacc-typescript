...
const ScientificLeadershipModule = () => {
  ...
  const module = scientificLeadershipCourseData[moduleIndex];
      ...
      try {
        ...
        if (!docSnap.exists()) {
          await setDoc(userRef, {
            'scientific-leadership': [module.id]
          });
        } else {
          await updateDoc(userRef, {
            'scientific-leadership': arrayUnion(module.id)
          });
        }
  ...
  return (
    <div className="min-h-screen bg-background pb-20">
      <div className="container mx-auto px-4 py-8">
        <Button 
          variant="ghost" 
          onClick={() => navigate('/course/scientific-leadership')}
          className="mb-6"
        >
              ...
              <CardContent>
                {!quizStarted ? (
                  ...
                  <div className="text-center py-8">
                    ...
                    <Button onClick={() => navigate('/course/scientific-leadership')}>
                      Return to Course
                    </Button>
                  </div>
                )}
...
export default ScientificLeadershipModule;
