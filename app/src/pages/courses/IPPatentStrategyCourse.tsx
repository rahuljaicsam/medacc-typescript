...
const IPPatentStrategyCourse = () => {
      ...
      if (user) {
        try {
          ...
          if (docSnap.exists()) {
            ...
            setCompletedModules(data['ip-patent-strategy'] || []);
          }
        } catch (error) {
  ...
  const progress = (completedModules.length / ipPatentStrategyCourseData.length) * 100;
  const isComplete = completedModules.length === ipPatentStrategyCourseData.length;
  ...
  const handleStartModule = (moduleId: number) => {
    ...
    navigate(`/course/ip-patent-strategy/module/${moduleId}`);
  };
    ...
    <div className="min-h-screen bg-background pb-20">
      ...
      <div className="bg-primary/5 border-b">
        <div className="container mx-auto px-4 py-12">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl font-bold mb-4">IP & Patent Strategy</h1>
            <p className="text-xl text-muted-foreground mb-8">
              Protect your innovations with comprehensive intellectual property strategies.
            </p>
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto grid gap-6">
          {ipPatentStrategyCourseData.map((module, index) => {
            const isCompleted = completedModules.includes(module.id);
            const isLocked = index > 0 && !completedModules.includes(ipPatentStrategyCourseData[index - 1].id);
            ...
            <Card className="bg-primary/5 border-primary/20">
              <CardContent className="pt-6">
                ...
                <p className="text-muted-foreground mb-6">
                  You have successfully completed the IP & Patent Strategy course.
                </p>
...
export default IPPatentStrategyCourse;
