...
import { strategicPartnershipsCourseData } from '../../data/strategicPartnershipsCourseData';
...
const StrategicPartnershipsCourse = () => {
      ...
      if (user) {
        try {
          ...
          if (docSnap.exists()) {
            ...
            setCompletedModules(data['strategic-partnerships'] || []);
          }
        } catch (error) {
  ...
  const progress = (completedModules.length / strategicPartnershipsCourseData.length) * 100;
  const isComplete = completedModules.length === strategicPartnershipsCourseData.length;
  ...
  const handleStartModule = (moduleId: number) => {
    ...
    navigate(`/course/strategic-partnerships/module/${moduleId}`);
  };
    ...
    <div className="min-h-screen bg-background pb-20">
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground mb-8">
              Build valuable partnerships with pharma companies, research institutions, and investors.
            </p>
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto grid gap-6">
          {strategicPartnershipsCourseData.map((module, index) => {
            const isCompleted = completedModules.includes(module.id);
            const isLocked = index > 0 && !completedModules.includes(strategicPartnershipsCourseData[index - 1].id);
            ...
            <Card className="bg-primary/5 border-primary/20">
              <CardContent className="pt-6">
                ...
                <p className="text-muted-foreground mb-6">
                  You have successfully completed the Strategic Partnerships course.
                </p>
...
export default StrategicPartnershipsCourse;
