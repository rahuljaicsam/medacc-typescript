...
const GrantWritingModule = () => {
  ...
  const module = grantWritingCourseData[moduleIndex];
      ...
      try {
        ...
        if (!docSnap.exists()) {
          await setDoc(userRef, {
            'grant-writing': [module.id]
          });
        } else {
          await updateDoc(userRef, {
            'grant-writing': arrayUnion(module.id)
          });
        }
  ...
  return (
    <div className="min-h-screen bg-background pb-20">
      <div className="container mx-auto px-4 py-8">
        <Button 
          variant="ghost" 
          onClick={() => navigate('/course/grant-writing')}
          className="mb-6"
        >
              ...
              <CardContent>
                {!quizStarted ? (
                  ...
                  <div className="text-center py-8">
                    ...
                    <Button onClick={() => navigate('/course/grant-writing')}>
                      Return to Course
                    </Button>
                  </div>
                )}
...
export default GrantWritingModule;
