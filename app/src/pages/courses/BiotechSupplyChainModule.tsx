...
const BiotechSupplyChainModule = () => {
  ...
  const module = biotechSupplyChainCourseData[moduleIndex];
      ...
      try {
        ...
        if (!docSnap.exists()) {
          await setDoc(userRef, {
            'biotech-supply-chain': [module.id]
          });
        } else {
          await updateDoc(userRef, {
            'biotech-supply-chain': arrayUnion(module.id)
          });
        }
  ...
  return (
    <div className="min-h-screen bg-background pb-20">
      <div className="container mx-auto px-4 py-8">
        <Button 
          variant="ghost" 
          onClick={() => navigate('/course/biotech-supply-chain')}
          className="mb-6"
        >
              ...
              <CardContent>
                {!quizStarted ? (
                  ...
                  <div className="text-center py-8">
                    ...
                    <Button onClick={() => navigate('/course/biotech-supply-chain')}>
                      Return to Course
                    </Button>
                  </div>
                )}
...
export default BiotechSupplyChainModule;
