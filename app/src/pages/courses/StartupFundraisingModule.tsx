...
const StartupFundraisingModule = () => {
  ...
  const module = startupFundraisingCourseData[moduleIndex];
      ...
      try {
        ...
        if (!docSnap.exists()) {
          await setDoc(userRef, {
            'startup-fundraising': [module.id]
          });
        } else {
          await updateDoc(userRef, {
            'startup-fundraising': arrayUnion(module.id)
          });
        }
  ...
  return (
    <div className="min-h-screen bg-background pb-20">
      <div className="container mx-auto px-4 py-8">
        <Button 
          variant="ghost" 
          onClick={() => navigate('/course/startup-fundraising')}
          className="mb-6"
        >
              ...
              <CardContent>
                {!quizStarted ? (
                  ...
                  <div className="text-center py-8">
                    ...
                    <Button onClick={() => navigate('/course/startup-fundraising')}>
                      Return to Course
                    </Button>
                  </div>
                )}
...
export default StartupFundraisingModule;
