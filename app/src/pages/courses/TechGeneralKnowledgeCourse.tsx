...
const TechGeneralKnowledgeCourse = () => {
    ...
    const fetchProgress = async () => {
      ...
      if (user) {
        try {
          ...
          if (docSnap.exists() && docSnap.data()['tech-general-knowledge']) {
            setUserProgress(docSnap.data()['tech-general-knowledge'].modules || {});
          }
        } catch (error) {
  ...
  const progressPercentage = Math.round((completedModules / techGeneralKnowledgeCourseModules.length) * 100);
    ...
    <div className="min-h-screen bg-gray-50 pb-12">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
            <div>
              ...
              <h1 className="text-4xl font-bold mb-4">Tech General Knowledge for Biotech</h1>
              <p className="text-xl text-blue-100 max-w-2xl">
                Essential technology concepts for modern innovators: Cloud, AI, IoT, Hardware, and Cybersecurity.
              </p>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 min-w-[300px]">
              ...
              <div className="flex justify-between text-sm text-blue-200">
                <span>{completedModules}/{techGeneralKnowledgeCourseModules.length} Modules</span>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-8">
        <div className="grid gap-6">
          {techGeneralKnowledgeCourseModules.map((module, index) => {
            const status = getModuleStatus(module.id);
            const isLocked = index > 0 && getModuleStatus(techGeneralKnowledgeCourseModules[index - 1].id) !== 'completed';
              ...
              >
                <div className="p-6 flex flex-col md:flex-row md:items-center gap-6">
                  ...
                  <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 min-w-[200px]">
                    ...
                    <button
                      onClick={() => !isLocked && navigate(`/course/tech-general-knowledge/module/${module.id}`)}
                      disabled={isLocked}
...
export default TechGeneralKnowledgeCourse;
