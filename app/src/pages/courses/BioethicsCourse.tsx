  ...
  const fetchProgress = async (uid: string) => {
    try {
      ...
      if (docSnap.exists()) {
        ...
        const courseData = data['bioethics-society'];
        ...
        if (courseData && courseData.modules) {
          ...
          setProgress(Math.round((completed.length / bioethicsCourseModules.length) * 100));
        }
      }
    } catch (error) {
      ...
      <main className="pt-24 pb-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6">
              <div>
                ...
                <p className="text-lg text-gray-600 max-w-3xl">
                  Explore ethical considerations in gene editing, AI, reproductive technologies, end of life care, and emerging biotechnologies.
                </p>
              </div>
              ...
              <Card className="p-6 bg-white shadow-sm border-gray-100 min-w-[300px]">
                ...
                <div className="flex items-center gap-2 text-sm text-gray-600">
                  ...
                  <span>{modulesCompletedCount} of {bioethicsCourseModules.length} modules completed</span>
                </div>
              </Card>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {bioethicsCourseModules.map((module, index) => {
              const isCompleted = completedModules.includes(module.id);
              const isLocked = index > 0 && !completedModules.includes(bioethicsCourseModules[index - 1].id) && !isCompleted;
              ...
              return (
                ...
                >
                  <Card 
                    ...
                    onClick={() => !isLocked && navigate(`/course/bioethics/module/${module.id}`)}
                  >
              ...
              <Card className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white p-8 md:p-12 text-center rounded-3xl overflow-hidden relative">
                <div className="relative z-10">
                  ...
                  <p className="text-blue-100 text-lg max-w-2xl mx-auto mb-8">
                    You've completed the Bioethics & Society course. You have demonstrated a strong understanding of complex ethical issues in modern biotechnology.
                  </p>
                  <Button 
                    size="lg" 
...
export default BioethicsCourse;
