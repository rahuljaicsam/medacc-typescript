...
import { grantWritingCourseData } from '../../data/grantWritingCourseData';
...
const GrantWritingCourse = () => {
      ...
      if (user) {
        try {
          ...
          if (docSnap.exists()) {
            ...
            setCompletedModules(data['grant-writing'] || []);
          }
        } catch (error) {
  ...
  const progress = (completedModules.length / grantWritingCourseData.length) * 100;
  const isComplete = completedModules.length === grantWritingCourseData.length;
  ...
  const handleStartModule = (moduleId: number) => {
    ...
    navigate(`/course/grant-writing/module/${moduleId}`);
  };
    ...
    <div className="min-h-screen bg-background pb-20">
      ...
      <div className="bg-primary/5 border-b">
        <div className="container mx-auto px-4 py-12">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl font-bold mb-4">Grant Writing for Non-Dilutive Funding</h1>
            <p className="text-xl text-muted-foreground mb-8">
              Secure SBIR/STTR grants and other non-dilutive funding sources for your startup.
            </p>
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto grid gap-6">
          {grantWritingCourseData.map((module, index) => {
            const isCompleted = completedModules.includes(module.id);
            const isLocked = index > 0 && !completedModules.includes(grantWritingCourseData[index - 1].id);
            ...
            <Card className="bg-primary/5 border-primary/20">
              <CardContent className="pt-6">
                ...
                <p className="text-muted-foreground mb-6">
                  You have successfully completed the Grant Writing course.
                </p>
...
export default GrantWritingCourse;
