...
import { marketAnalysisCourseData } from '../../data/marketAnalysisCourseData';
...
const MarketAnalysisCourse = () => {
      ...
      if (user) {
        try {
          ...
          if (docSnap.exists()) {
            ...
            setCompletedModules(data['market-analysis'] || []);
          }
        } catch (error) {
  ...
  const progress = (completedModules.length / marketAnalysisCourseData.length) * 100;
  const isComplete = completedModules.length === marketAnalysisCourseData.length;
  ...
  const handleStartModule = (moduleId: number) => {
    ...
    navigate(`/course/market-analysis/module/${moduleId}`);
  };
    ...
    <div className="min-h-screen bg-background pb-20">
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground mb-8">
              Master market research and competitive analysis for biotech ventures.
            </p>
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto grid gap-6">
          {marketAnalysisCourseData.map((module, index) => {
            const isCompleted = completedModules.includes(module.id);
            const isLocked = index > 0 && !completedModules.includes(marketAnalysisCourseData[index - 1].id);
              ...
              <div className="flex items-center gap-6">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Complete all 9 modules to unlock your Market Analysis certification.
                  </p>
                </div>
              </div>
              <Button 
...
export default MarketAnalysisCourse;
