...
const ExitStrategiesModule = () => {
  ...
  const module = exitStrategiesCourseData[moduleIndex];
      ...
      try {
        ...
        if (!docSnap.exists()) {
          await setDoc(userRef, {
            'exit-strategies': [module.id]
          });
        } else {
          await updateDoc(userRef, {
            'exit-strategies': arrayUnion(module.id)
          });
        }
  ...
  return (
    <div className="min-h-screen bg-background pb-20">
      <div className="container mx-auto px-4 py-8">
        <Button 
          variant="ghost" 
          onClick={() => navigate('/course/exit-strategies')}
          className="mb-6"
        >
              ...
              <CardContent>
                {!quizStarted ? (
                  ...
                  <div className="text-center py-8">
                    ...
                    <Button onClick={() => navigate('/course/exit-strategies')}>
                      Return to Course
                    </Button>
                  </div>
                )}
...
export default ExitStrategiesModule;
