...
const LegalGeneralKnowledgeModule = () => {
  ...
  const module = legalGeneralKnowledgeCourseData[moduleIndex];
      ...
      try {
        ...
        if (!docSnap.exists()) {
          await setDoc(userRef, {
            'legal-general-knowledge': [module.id]
          });
        } else {
          await updateDoc(userRef, {
            'legal-general-knowledge': arrayUnion(module.id)
          });
        }
  ...
  return (
    <div className="min-h-screen bg-background pb-20">
      <div className="container mx-auto px-4 py-8">
        <Button 
          variant="ghost" 
          onClick={() => navigate('/course/legal-general-knowledge')}
          className="mb-6"
        >
              ...
              <CardContent>
                {!quizStarted ? (
                  ...
                  <div className="text-center py-8">
                    ...
                    <Button onClick={() => navigate('/course/legal-general-knowledge')}>
                      Return to Course
                    </Button>
                  </div>
                )}
...
export default LegalGeneralKnowledgeModule;
